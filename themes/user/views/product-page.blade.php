        ...
        <div class="col-md-10" style="margin-bottom: 35px">
                    ...
                    <div class="col-12 px-0" style="height: 100%;">
                        ...
                        <div class="p-0 mt-2">
                            <div class="d-flex flex-wrap justify-content-start" style="width: 100%">
                                <article class="d-flex align-items-end my-2 px-2 product" style="width: 100%;">
                                    <div class="d-flex flex-wrap" style="width: 100%">
                                        <div class=" position-relative product-img" style="width: 24%; border-top-left-radius: 5px; border-bottom-left-radius: 5px">
                                        ...
                                        <div class="d-flex bg-white align-items-end product-desc p-4" style="width: 76%; border-top-right-radius: 5px; border-bottom-right-radius: 5px;">
                                            <div class="p-1 py-3 d-flex flex-column col-12">
                                                <h4 class="font-weight-bold mb-3" style="width: 100%"> {{ ucfirst($product->name) }} </h4>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center" style="width: 100%">
                                                    <h4 class="font-weight-bold mb-0" style="width: 50%;">  &dollar;{{ sprintf("%.2f",  $product->price ) }} </h4>
                                                    @guest
                                                        <div class="bg-white px-3 add-to-cart position-relative">
                                                            ...
                                                            <div class="p-0 position-absolute w-100 d-none align-items-center
                                                                   justify-content-around add-to-cart-req" style="box-sizing: border-box; top: -6px">
            ...
            <div class="justify-content-between m-0 p-0" style="width: 100%;">
                <div class="col-12 px-0">
                    <h5 class="font-weight-bold mb-3"> You might also like </h5>
                                             ...
                                             <div class="splide__track">
                                                 <ul class="splide__list">
                                                     @foreach($featured_products as $featured_product)
                                                         <li class="splide__slide card mt-2 px-0" style="width: 100%;">
                                                             <div class="card-body pb-1 px-3 py-2">
                                                                 <div class="col-12" style="height: 140px">
                                                                     <img src="{{asset('storage/products/'.$featured_product->img)}}"
                                                                          style="height: 100%; width: 100%"
                                                                          alt="">
                                                                 </div>
                                                                 <div class="col-12 px-0 py-2 pb-0 mb-0 d-flex flex-column justify-content-between">
                                                                     <a class="col-12 font-weight-bold mt-0 mb-3 px-0" href="{{ route('product', ['product' => $featured_product->slug]) }}">
                                                                         {{ $featured_product->name }}
                                                                     </a>
                                                                     <h5 class="col-12 m-0 font-weight-bold mb-0 px-0">
                                                                         &dollar; {{ sprintf("%.2f", $featured_product->price) }}
                                                                     </h5>
                                                                 </div>
                                                             </div>
                                                             @guest
                                                                 <div class="card-footer bg-white px-3 add-to-cart position-relative">
                                                                     ...
                                                                     <div class="p-0 position-absolute w-100 d-none align-items-center justify-content-around add-to-cart-req" style="box-sizing: border-box">
                                                                         <a class="nav-link text-primary p-0 py-2" href="{{ route('login')  }}">
                                                                             Log In
                                                                         </a>
                                                                         <a class="nav-link text-secondary p-0" href=" {{ route('register')  }} ">
                                                             ...
                                                             @else
                                                                 <div class="card-footer bg-white px-3">
                                                                     <form action="{{ route('cart') }}" method="post" class="m-0 p-0">
                                                                         @csrf
                                                                         <input type="number" class="d-none" name="product_id" value="{{ $featured_product->id }}"/>
                                                                         <input type="submit" class="font-weight-bold btn btn-primary btn-sm btn-block" value="Add to cart" >
                                                                     </form>
                                                                 </div>
                                                             @endguest
