            ...
            <div class="rounded p-3 bg-white" style="margin-top: 2vh; width: 100%">
                <div class="container d-flex p-0 justify-content-between">
                    <div class="rounded col-12 px-0">
                        <h6 class="py-1 mb-0"> Información de Usuario </h6>
                        <hr>
                    </div>
                </div>
               {{-- Account Settings --}}
                        ...
                        <form>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="validation1">Nombre completo</label>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="validation3">Nueva contraseña</label>
                                    <input type="text" class="form-control" id="validation3" aria-describedby="validation3Feedback" required>
                                </div>
                            </div>

                            <div class="form-group d-flex justify-content-end">
                                <button class="btn btn-primary font-weight-bold btn-sm" type="submit">Actualizar datos</button>
                            </div>
                        </form>
                    </div>
                </div>
