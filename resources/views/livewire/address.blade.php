<div class="p-0 m-0">
    ...
    <div class="container d-flex p-0 justify-content-between">
        <div class="rounded col-12 px-0">
            <h6 class="py-1 mb-0"> Dirección </h6>
            <hr>
        </div>
    </div>
    <div class="container d-flex p-0 justify-content-between">
        <div class="col-12 rounded p-2 px-3">
            <div>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="validationServer03">Dirección 1</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="validationServer04">Dirección 2</label>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="validationServer06">Número telefónico</label>
                ...
                <div class="form-group d-flex justify-content-end">
                    <button class="btn btn-primary btn-sm font-weight-bold" wire:click="store">Actualizar datos</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container d-flex p-0 justify-content-between">
        <div class="col-12 rounded p-2 px-3">
            <div>
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="validationServer07">Ciudad</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="validationServer08">Colonia</label>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="validationServer09">Dirección 1</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="validationServer10">Dirección 2</label>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="validationServer11">Código Postal</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="validationServer12">Número telefónico</label>
